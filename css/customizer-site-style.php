...
--custom-color-1: #9fd08c;
--custom-color-1-darker: #8ac673;
--custom-color-1-r: 159;
--custom-color-1-g: 208;
--custom-color-1-b: 140;
--custom-color-1-contrast: black;
--custom-color-1-contrast-darker: white;
--custom-color-1-text-color: var(--body-color);
--custom-color-2: rgba(var(--custom-color-2-r),var(--custom-color-2-g),var(--custom-color-2-b),0.46);
--custom-color-2-darker: rgba(108,37,1,0.46);
--custom-color-2-r: 120;
--custom-color-2-g: 41;
--custom-color-2-b: 1;
--custom-color-2-contrast: white;
--custom-color-2-contrast-darker: white;
--custom-color-2-text-color: var(--body-alt-color);
--custom-color-3: rgba(var(--custom-color-3-r),var(--custom-color-3-g),var(--custom-color-3-b),0.41);
--custom-color-3-darker: rgba(108,37,1,0.41);
--custom-color-3-r: 120;
--custom-color-3-g: 41;
--custom-color-3-b: 1;
...
--bg-contrast: var(--body-color);
        ...
        {
            color: var(--custom-color-3) !important;
        }</style><style id="typography" typography="custom-page-typography-2">
        .u-body
        {
        ...
        --largeText-line-height: 1.6;
        --largeText-list-icon-spacing: 0.3;
        --largeText-list-icon-size: 0.8;
        ...
        --text-list-icon-spacing: 0.3;
        --text-list-icon-size: 0.8;
        ...
        line-height: var(--largeText-line-height);
        list-icon-spacing: var(--largeText-list-icon-spacing);
        list-icon-size: var(--largeText-list-icon-size);
        }
        p.u-small-text
        {
        ...
        list-icon-spacing: var(--text-list-icon-spacing);
        list-icon-size: var(--text-list-icon-size);
        }
        .u-btn
        {
